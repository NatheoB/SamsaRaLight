...
Information about Prenovel marteloscope in Jura (France) used as an
example for light interception by symetrical crowns.
...
`data_prenovel`, a named list with 3 elements:
...
- info:
  ...
  :   Horizontal extent of the site (meters).

  size_y

  :   Vertical extent of the site (meters).
