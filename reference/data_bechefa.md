...
Information about bechefa marteloscope in Belgium used as an example
estimating light interception using complex asymmetric crown shapes.
...
`data_bechefa`, a named list with 4 elements:
