...
# The slope of the stand (in degrees)
slope <- infos[["slope"]]
...
# i.e. direction of slope in real-world coordinates
aspect <- infos[["aspect"]]

# Angle from North to x axis clockwise. (in degrees)
# x-axis points North : 0, x-axis points East : 90, x-axis points South : 180, x-axis points West : 270
# Default 90 correspond to a Y axis oriented toward the North.
# i.e. rotation of real North relative to plot x-axis
