...
```{r}
inv_shifted <- SamsaRaLight::create_rect_stand(data_trees, cell_size, core_polygon = core_polygon)
```
...
```{r out_samsa}
inv_filled <- SamsaRaLight::fill_rect_stand(inv_shifted$new_inventory, 
