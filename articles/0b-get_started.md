...
1.  [A first minimal
    case](https://natheob.github.io/SamsaRaLight/articles/articles/1-minimal_case.md) -
    *Compute tree light interception by symmetric crowns in an
    axis-aligned rectangle plot*
2.  [Understand ray
    discretization](https://natheob.github.io/SamsaRaLight/articles/articles/2-discretisation_directdiffuse.md) -
    *Discretization of direct and diffuse radiations into rays*
3.  [More complex crown shapes and
    inventories](https://natheob.github.io/SamsaRaLight/articles/articles/3-complex_cases.md) -
    *Represent tree crowns with asymmetric shapes and use
    non-axis-aligned GPS inventory or non-rectangular inventory zone*
4.  [Understand ray
    transmission](https://natheob.github.io/SamsaRaLight/articles/articles/4-transmission_interception.md) -
    *Transmission models : porous envelope and turbid medium crowns*
5.  [Virtual
    sensors](https://natheob.github.io/SamsaRaLight/articles/articles/5-virtual_sensors.md) -
