...
the package as
[`SamsaRaLight::data_prenovel`](https://natheob.github.io/SamsaRaLight/reference/SamsaRaLight_data.md).
...
For advanced users, another function is available
[`SamsaRaLight::run_sl_advanced()`](https://natheob.github.io/SamsaRaLight/reference/run_sl_advanced.md),
allowing to control deeper ray-tracing parameters. The user-friendly
function
[`SamsaRaLight::run_sl()`](https://natheob.github.io/SamsaRaLight/reference/run_sl.md)
internally wrap the advanced version with default parameters. In the
...
#>  $ e      : num  416 446 424 428 426 ...
#>  $ pacl   : num  0.0918 0.0984 0.0935 0.0943 0.094 ...
#>  $ punobs : num  0.399 0.449 0.518 0.479 0.394 ...
```
...
#>  $ epot   : num  413075 276825 225091 89701 233537 ...
#>  $ e      : num  117308 100892 58737 16557 8306 ...
#>  $ lci    : num  0.716 0.636 0.739 0.815 0.964 ...
#>  $ eunobs : num  90327 87858 49288 12039 1494 ...
```
...
#> ---------------------------
#>       epot               e                 lci         
#>  Min.   :  11220   Min.   :   650.9   Min.   :0.07583  
#>  1st Qu.: 171395   1st Qu.: 23641.6   1st Qu.:0.58650  
#>  Median : 306618   Median : 71049.0   Median :0.73856  
#>  Mean   : 334288   Mean   :118508.3   Mean   :0.70658  
#>  3rd Qu.: 468542   3rd Qu.:183600.2   3rd Qu.:0.85200  
#>  Max.   :1044645   Max.   :750821.7   Max.   :0.99318  
#> 
#> Cells (ground light)
#> -------------------
#>        e                pacl             punobs      
#>  Min.   :  71.97   Min.   :0.01587   Min.   :0.0000  
#>  1st Qu.: 375.87   1st Qu.:0.08288   1st Qu.:0.3982  
#>  Median : 559.70   Median :0.12341   Median :0.5677  
#>  Mean   : 604.63   Mean   :0.13332   Mean   :0.5389  
#>  3rd Qu.: 780.17   3rd Qu.:0.17203   3rd Qu.:0.7046  
